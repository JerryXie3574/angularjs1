...
**************************/
	...
	try{	
		 ...
		 if (navigator.userAgent.indexOf('Firefox')>=0){
			 ...
			 window.location.href="/ocx/install_lodop32.html";
		 };
		 if (is64IE) {
		     //document.write(strHtm64_Install);
			 window.location.href="/ocx/install_lodop64.html";
		 } else	if (isIE)   {
		...
		if (is64IE){
			...
			window.location.href="install_lodop32.html";
		} else {
		...
		return LODOP;
	     ...
	     //LODOP.SET_LICENSES("济南凌空信息科技有限公司","056626680837475919278901905623","","");
	     //=======================================
	     return LODOP; 
	}catch(err){
		if (is64IE)	
